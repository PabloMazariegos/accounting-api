...
public class RabbitMQConfig {
    ...
    public static final String QUEUE_NAME = "accounting_queue";
    public static final String EXCHANGE_NAME = "accounting_topic_exchange";
    public static final String ROUTING_KEY = "accounting_message";
