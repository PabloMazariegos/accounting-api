...
ALTER TABLE
    "taxes_configuration"
    ADD CONSTRAINT "taxes_configuration_slug_unique" UNIQUE ("slug");
...
ALTER TABLE
    "isr_annual_integration"
    ADD PRIMARY KEY ("id");
ALTER TABLE
    "sales"
    ADD CONSTRAINT "sales_sat_file_id_foreign" FOREIGN KEY ("sat_file_id") REFERENCES "sat_files" ("id");
ALTER TABLE
    "purchases"
    ADD CONSTRAINT "purchases_sat_file_id_foreign" FOREIGN KEY ("sat_file_id") REFERENCES "sat_files" ("id");